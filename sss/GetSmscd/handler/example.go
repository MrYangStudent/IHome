...
func (e *Example) GetSmscd(ctx context.Context, req *example.Request, rsp *example.Response) error {
	...
	//四位 1000-9999   8999+1000
	//5位  10000-99999  89999+1000
	//2位
	...
	//预先创建好的appid
	messageconfig["appid"] = "需要替换appid"
	//预先获得的app的key
	messageconfig["appkey"] = "需要替换秘钥"
	//加密方式默认
	...
	//短信发送的手机号
	submail.MessageXSendAddTo(messagexsend, req.Mobile)//替换要发送消息手机号
	//短信发送的模板
